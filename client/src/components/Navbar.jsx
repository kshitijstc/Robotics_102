...
function Navbar({ bgColor, color}) {
  ...
  return (
    <nav className='navbar w-full flex px-10 py-10 justify-between items-center' style={{ backgroundColor: bgColor, color: color }}>
      <Link to='/'><img src={roboClubImage} alt="" className="h-[50px] w-[57px] ml-1 mr-5 mb-1" /></Link>
      <h1 className=' h-[32px] ' alt="logo"><Link to='/'>RB <span className='ml-1'>101</span></Link></h1>
